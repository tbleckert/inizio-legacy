...
class Custom_Post_Type_Helper {
	 ...
	 */
	public function __construct($post_type, $post_type_args = array(), $permalink_args = array(), $taxonomies = array()) {
		...
		if (!empty($taxonomies)) {
			if (is_array($taxonomies)) {
				...
				register_taxonomy_for_object_type($taxonomies, $post_type);
			}
		}
